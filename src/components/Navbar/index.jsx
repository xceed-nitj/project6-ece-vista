  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ 
          height: "30px",
          background: "linear-gradient(90deg, #0f766e 0%, #2c5252 100%)" // Gradient from teal-700 to teal-800
        }}
      >
        <div className="flex w-full justify-between items-center text-white px-4 py-0 gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs lg:text-sm font-medium tracking-wide text-teal-100">
              cipher@nitj.ac.in
            </p>
          </div>
            ...
            <div className="mx-auto">
              ...
              >
                <div className="relative z-10 flex items-center lg:hidden ">
                  <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-teal-800 hover:bg-teal-50 hover:text-teal-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-200">
                      ...
                      <Disclosure>
                        {({ open }) => (
                          <>
                            ...
                            <Disclosure.Panel className="space-y-1 bg-teal-50">
                              {item.subItems.map((subItem) => (
                                <Link
                                  key={subItem.name}
                                  to={subItem.href}
                                  className="block pl-8 pr-3 py-2 text-sm font-medium text-teal-800 hover:bg-teal-100 hover:text-teal-900"
                                >
                                  {subItem.name}
                                </Link>
                              ))}
